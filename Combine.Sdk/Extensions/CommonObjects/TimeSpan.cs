...
namespace Combine.Sdk.Extensions.CommonObjects
{
  ...
  public static class TimeSpanExtensions
  {
    ...
    /// <summary>
    /// Checks if the given TimeSpan array is not valid or contains any non-valid value inside
    /// </summary>
    /// <param name="array">Array of TimeSpan to evaluate</param>
    /// <returns>True or False</returns>
    public static bool IsNotValid(this TimeSpan[] array)
    {
    ...
    /// <returns>True or False</returns>
    public static bool IsNotValid(this List<TimeSpan> list)
    {
